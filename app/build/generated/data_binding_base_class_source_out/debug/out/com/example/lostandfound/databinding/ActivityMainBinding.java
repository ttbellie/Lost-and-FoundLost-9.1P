...
public final class ActivityMainBinding implements ViewBinding {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.btn_create_advert;
      Button btnCreateAdvert = ViewBindings.findChildViewById(rootView, id);
      if (btnCreateAdvert == null) {
        break missingId;
      }

      id = R.id.btn_show_all_items;
      Button btnShowAllItems = ViewBindings.findChildViewById(rootView, id);
      if (btnShowAllItems == null) {
        break missingId;
      }
